...
### Power Cycle
With the bulb connected to a power source, cycle the power  where the bulb is on for 5 seconds and off for 2 seconds.
Once the cycle is completed 5 times and the bulb lights up the 6th time, the bulb will flash, indicating pairing mode.
